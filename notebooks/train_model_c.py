...
# COMMAND ----------
"""Train Model C: NGBoost (distributional).

Loads the training set, validates it, runs an Optuna hyperparameter
search over NGBoost with a Normal output distribution, and logs all
trials plus the best model to MLflow. Passes the resulting run ID to
downstream tasks via job task values.
"""
import sys
import os
...
dbutils.jobs.taskValues.set(key="model_type", value="ngboost")
