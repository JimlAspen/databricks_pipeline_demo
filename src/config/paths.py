...
BRONZE_TABLE = f"{CATALOG}.{MEDALLION_SCHEMA}.bronze_diabetes"
SILVER_TABLE = f"{CATALOG}.{MEDALLION_SCHEMA}.silver_diabetes"
GOLD_TABLE = f"{CATALOG}.{MEDALLION_SCHEMA}.gold_diabetes_features"
...
MODEL_NAME = f"{CATALOG}.{ML_SCHEMA}.diabetes_progression_model"
